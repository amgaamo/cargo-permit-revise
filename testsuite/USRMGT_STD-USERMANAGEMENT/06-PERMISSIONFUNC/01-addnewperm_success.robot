...
*** Test Cases ***
CASE01-Add new permission code

      Pass Execution If    '${GLOBAL_USERMGT_FUNCTEST}'=='False'             
      ...    \nNo Execute this function: GLOBAL_USERMGT_FUNCTEST is ${GLOBAL_USERMGT_FUNCTEST}.
    
      commonkeywords.Click button on list page      ${LOCATOR_ADDPERM_BTN}
      commonkeywords.Verify Page Name is correct    Add Permission
      commonkeywords.Wait Loading progress
      commonkeywords.Fill in data form    ${LOCATOR_PERMCODE_FIELD}    ${DS_PERM['addnew'][${perm_col.permCode}]}
