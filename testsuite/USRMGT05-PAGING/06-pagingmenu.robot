...
...                                       \nNo Execute this function: GLOBAL_PAGING_FUNCTEST is ${GLOBAL_PAGING_FUNCTEST}.
...               AND               commonkeywords.Fill in search field on list page    ${LOCATOR_SEARCHBYMENU_SEL}        ${MENUSEARCHBY}[menuname]
...               AND               commonkeywords.Fill in search field on list page    ${LOCATOR_SEARCHMENU_KEYWORD}      XBOTPAGING
...               AND               commonkeywords.Click button on list page            ${LOCATOR_SEARCHMENU_BTN}
...
CASE-Paging is correct
        ...
        commonkeywords.Fill in search field on list page    ${LOCATOR_SEARCHMENU_KEYWORD}       XBOTPAGING
...
CASE-Change Showing Page
        ...
        commonkeywords.Go to SUBMENU name    ${mainmenu}[configuration]      ${submenu}[menuMgt]
        commonkeywords.Verify Page Name is correct    pagename=${menuname}[menuMgt]
