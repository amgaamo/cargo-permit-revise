...
...               AND               commonkeywords.Fill in search field on list page    ${LOCATOR_SEARCHCOM_KEYWORD}        XBOTPAGING
...
CASE-Paging is correct
        ...
        commonkeywords.Fill in search field on list page    ${LOCATOR_SEARCHCOM_KEYWORD}        XBOTPAGING
