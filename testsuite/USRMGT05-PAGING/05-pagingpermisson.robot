...
...               AND               commonkeywords.Fill in search field on list page    ${LOCATOR_SEARCHPERM_KEYWORD}      XBOTPAGING
...
CASE-Paging is correct
        ...
        commonkeywords.Fill in search field on list page    ${LOCATOR_SEARCHPERM_KEYWORD}       XBOTPAGING
...
CASE-Change Showing Page
        ...
        commonkeywords.Go to SUBMENU name    ${mainmenu}[configuration]      ${submenu}[permMgt]
        commonkeywords.Verify Page Name is correct    pagename=${menuname}[permMgt]
