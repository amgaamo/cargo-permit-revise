...
...               AND               commonkeywords.Fill in search field on list page    ${LOCATOR_SEARCHGROUP_KEYWORD}      XBOTPAGING
...
CASE-Paging is correct
        ...
        commonkeywords.Fill in search field on list page    ${LOCATOR_SEARCHGROUP_KEYWORD}      XBOTPAGING
