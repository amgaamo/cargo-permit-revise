...
...                                       \nNo Execute this function: GLOBAL_PAGING_FUNCTEST is ${GLOBAL_PAGING_FUNCTEST}.
...               AND               Fill in search field on list page    ${LOCATOR_SEARCHBYROLE_SEL}        ${ROLESEARCHBY}[rolename]
...               AND               commonkeywords.Fill in search field on list page    ${LOCATOR_SEARCHROLE_KEYWORD}      XBOTPAGING
...               AND               commonkeywords.Click button on list page            ${LOCATOR_SEARCHROLE_BTN}
...
CASE-Paging is correct
        ...
        commonkeywords.Fill in search field on list page    ${LOCATOR_SEARCHROLE_KEYWORD}       xbotpaging
...
CASE-Change Showing Page
        ...
        commonkeywords.Verify Page Name is correct    pagename=${menuname}[roleMgt]
