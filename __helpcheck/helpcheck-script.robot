...
Helpcheck Call API service
      Request Service Get Session Data    ${DS_LOGIN['superadmin'][${login_col.username}]}      ${DS_LOGIN['superadmin'][${login_col.password}]}
      Should Be Equal    ${GLOBAL_APIUSERNAME}       ${DS_LOGIN['superadmin'][${login_col.username}]}
      Request Service Logout System       ${DS_LOGIN['superadmin'][${login_col.username}]}      ${DS_LOGIN['superadmin'][${login_col.password}]}
      Log To Console      \nhelpcheck status PASS.
